...
namespace AoacControl.Controllers
{
    public class AssociadosController : Controller
    {
        ...
        public AssociadosController(AssociadoService associadoService, ComunidadeService comunidadeService)
        {
        ...
        public async Task<IActionResult> Create()
        {
            ...
            var viewModel = new AssociadoFormViewModel { Comunidades = comunidade };
        ...
        public async Task<IActionResult> Edit (int? id)
        {
            ...
            AssociadoFormViewModel viewModel = new AssociadoFormViewModel { Associado = associado, Comunidades = comunidade };
            return View(viewModel);
        }
        ...
        public async Task<IActionResult> Edit (int id, Associado associado)
        {
            ...
            {
                var comunidade = await _comunidadeService.FindAllAsync();
                var viewModel = new AssociadoFormViewModel { Associado = associado, Comunidades = comunidade };
                return View(viewModel); 
            }
